...
disc = {
    ...
    [
        ...
        "Задание 3: поиск и сортировка в базах данных",
        ...
        "Задание 7: кодирование графической и звуковой информации",
        "Задание 8: комбинаторика",
        "Задание 9: обработка числовой информации в электронных таблицах",
        "Задание 10: поиск слова в текстовых документах",
        ...
        "Задание 17: обработка целочисленных данных. Проверка делимости",
        "Задание 18: динамическое программирование в электронных таблицах",
        "Задания 19-21: теория игр",
        "Задание 22: многопоточные вычисления",
        "Задание 23: динамическое программирование",
        "Задание 24: обработка символьных строк",
        "Задание 25: обработка целочисленных данных. Поиск делителей",
        "Задание 26: обработка данных с помощью сортировки",
        "Задание 27: анализ данных",
        "Тест! Проверь свои знания",
    ],
    ...
    [
        ...
        "Задание 2: динамика",
        "Задание 3: законы сохранения в механике",
        "Задание 4: статика. Механические колебания и волны",
        "Задание 5: механика",
        "Задание 6: механика",
        "Задание 7: молекулярная физика",
        "Задание 8: МКТ и молекулярная физика",
        "Задание 9: молекулярная физика и термодинамика",
        "Задание 10: молекулярная физика и термодинамика. Изменение физических величин",
        "Задание 11: электрическое поле. Законы постоянного тока",
        "Задание 12: магнитное поле. Электромагнитная индукция",
        "Задание 13: электромагнитные колебания и волны. Оптика",
        "Задание 14: электродинамика. Анализ физических процессов",
        "Задание 15: Электродинамика. Изменение физических ыеличин и установление соответствия",
        "Задание 16: ядерная физика",
        "Задание 17: квантовая физика. Изменение физических величин",
        "Задание 18: физический смысл величин, законов, закономерностей",
        "Задание 19: механика - квантовая физика. Показания измерительных приборов",
        "Задание 20: механика - квантовая физика. Планирование эксперимента",
        "Тест! Проверь свои знания",
    ]
}
